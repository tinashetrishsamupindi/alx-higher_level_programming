...
/**
* print_python_bytes - Checks in the event that the item is a Python bytes object.
* @p: Pointer to a Python object.
* Return: void.
*/
void print_python_bytes(PyObject *p)
...
/**
* print_python_float - Checks in the event that the item is a Python float object.
* @p: Pointer to a Python object.
* Return: void.
*/
void print_python_float(PyObject *p)
